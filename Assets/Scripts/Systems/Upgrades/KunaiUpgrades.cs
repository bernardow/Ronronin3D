        ...
        public void SetUpgradeData()
        {
            ...
            switch (_currentLevel)
            {
                case 1: 
                    ...
                    break;
                case 2: _player.PlayerKunaiAttack.CooldownTimer = 0.45f;
                    break;
                case 3: _player.PlayerKunaiAttack.CooldownTimer = 0.3f;
                    break;
                case 4: _player.PlayerKunaiAttack.CooldownTimer = 0.15f;
                    break;
